  ...
  return (
    <section className="py-12">
      <div className="container mx-auto px-6 lg:px-12">
        <h1 className="font-inter text-blue-800 underline text-[36px] font-bold text-center mb-6">
        ...
        <div className="space-y-8">
          ...
          <div className="p-6 rounded-[4px] shadow-md">
            <h2 className="font-inter text-[24px] text-blue-800 underline font-semibold mb-4">
              What is AI?
            </h2>
