  ...
  return (
    <section className="py-12">
      <div className="container mx-auto px-6 lg:px-12">
        <h1 className="font-inter text-blue-800 underline text-[36px] font-bold text-center mb-6">Cybersecurity</h1>

        <div className="space-y-8">
          {/* Introduction */}
          <div className="p-6 rounded-[4px] shadow-md">
            <h2 className="font-inter text-[24px] text-blue-800 underline font-semibold mb-4">What is Cybersecurity?</h2>
          ...
          <div className="p-6 rounded-[4px] shadow-md">
            <h2 className="font-inter text-[24px] text-blue-800 underline font-semibold mb-4">Cybersecurity Threats</h2>
            <p className="font-inter text-[18px] text-[#333333] font-normal">
          ...
          <div className="p-6 rounded-[4px] shadow-md">
            <h2 className="font-inter text-[24px] text-blue-800 underline font-semibold mb-4">Types of Cybersecurity</h2>
            <p className="font-inter text-[18px] text-[#333333] font-normal">
          ...
          <div className="p-6 rounded-[4px] shadow-md">
            <h2 className="font-inter text-[24px] text-blue-800 underline font-semibold mb-4">Cybersecurity Tools and Techniques</h2>
            <p className="font-inter text-[18px] text-[#333333] font-normal">
