      ...
      <div className="flex justify-between w-full">
        <div className="flex md:gap-2 justify-center items-center">
          <div className="flex-shrink-0">
            <Image src="/log0.jpg" alt="logo" width={100} height={100} />
          </div>
          <h1 className="font-inter underline text-[28px] font-extrabold text-fuchsia-800">
            Mobina Blog...
          </h1>
        </div>
        ...
        <nav className="hidden md:flex justify-center items-center gap-10 mr-4">
          <Link
            href="/"
            className="font-inter text-fuchsia-800 underline text-[18px] font-medium"
          >
            Home
          </Link>
          <Link
