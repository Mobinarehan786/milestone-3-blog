    ...
    <section className="w-full overflow-hidden">
      <div className="container mx-auto flex px-5 py-10 md:flex-row flex-col items-center">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="font-inter underline sm:text-[40px] text-[30px] mb-4 font-medium text-red-700">
            Discover the Future of Technology
          </h1>
          <h2 className="hidden lg:inline-block font-inter text-[24px] underline text-green-500 font-medium">
            Stay Informed with the Latest Innovations
          </h2>
          <p className="mb-4 mt-2 font-inter text-[18px] text-[#333333] font-medium">
