...
function Commentsection() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      <h1 className="font-inter font-bold text-red-700 underline text-[24px] sm:text-[30px] mb-4">
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-md">
        ...
        <button
          type="submit"
          className="mt-4 w-full bg-fuchsia-900 text-[#ffffff] p-2 rounded-[4px] font-inter text-[18px] font-normal"
        >
          Submit Comment
        </button>
      </form>
