  ...
  return (
    <section className="w-full overflow-hidden">
      ...
      <div className="container mx-auto text-center mb-16">
        <h2 className="font-inter text-[36px] font-bold underline text-red-700 mb-4">
          Featured Articles
        </h2>
        <p className="font-inter text-[18px] font-medium text-[#333333]">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-10 md:gap-14">
        ...
        <div className="md:w-[370px] sm:w-[400px] w-[350px] p-4">
          <div className="p-6 rounded-[4px] shadow-[#333333] border shadow-md hover:bg-[#eeecec91]">
            <h3 className="font-inter text-[20px] text-red-700 font-medium mb-2">
              How AI is Changing the Future of Work
            </h3>
            <p className="font-inter text-[16px] text-[#333333] font-medium mb-4">
              Discover how artificial intelligence is revolutionizing industries
              and changing the workforce as we know it.
            </p>
            <button className="font-inter text-[18px] font-normal text-red-400">
        ...
        {/* article-card 2 */}
        <div className="md:w-[370px] sm:w-[400px] w-[350px] p-4">
          <div className="p-6 rounded-[4px] border shadow-[#333333] shadow-md hover:bg-[#eeecec91]">
            <h3 className="font-inter text-[20px]  text-red-700 font-medium mb-2">
        ...
        {/* article-card 3 */}
        <div className="md:w-[370px] sm:w-[400px] w-[350px] p-4">
          <div className="p-6 rounded-[4px] shadow-[#333333] shadow-md border hover:bg-[#eeecec91]">
            <h3 className="font-inter text-[20px] text-red-700 font-medium mb-2">
